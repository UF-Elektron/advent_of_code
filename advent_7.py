...
hands_sorted_by_type = [{'cards': '32T3K', 'card_points': [3, 2, 10, 3, 13], 'bid': '765', 'type': 1},
                        ...
                        {'cards': 'T55J5', 'card_points': [10, 5, 5, 11, 5], 'bid': '684', 'type': 4},
                        {'cards': 'QQQJA', 'card_points': [12, 12, 12, 11, 14], 'bid': '483', 'type': 4}]
...
#print(equal_type_ranges)
sorted_2222 = sorted(hands_sorted_by_type, key=lambda hand: hand['card_points'])
print(sorted_2222)
print("_---------------____---_-_---_-------------")
